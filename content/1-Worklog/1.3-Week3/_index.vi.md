...
* Học các công cụ cần thiết cho workshop của FCJ.
* Cài đặt và sử dụng Hugo để xây dựng trang tài liệu.
* Sử dụng Markdown để viết nội dung.
* Tìm hiểu các dịch vụ AWS cơ bản phục vụ hosting: S3, IAM, CloudFront.
* Chuẩn bị nền tảng để triển khai website ở các tuần sau.
...
* Cài đặt và sử dụng Hugo để xây dựng trang documentation.
* Nắm vững Markdown để viết nội dung cho workshop.
* Đã thêm nội dung Week 1 & Week 2 vào Hugo và chạy website local.
* Hiểu cơ bản về S3 (bucket, object) phục vụ cho hosting.
* Biết cách dùng IAM để cấp quyền truy cập an toàn.
* Nắm kiến thức cơ bản về CloudFront và CDN.
